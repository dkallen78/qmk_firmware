...
bool process_record_user(uint16_t keycode, keyrecord_t *record) {
  switch (keycode) {
    ...
    case DKA_I:
      if (record->event.pressed) {
        SEND_STRING(SS_DOWN(X_LALT)SS_TAP(X_P1)SS_TAP(X_P6)SS_TAP(X_P1)SS_UP(X_LALT));
      } else {
    ...
    case DKA_O:
      if (record->event.pressed) {
        SEND_STRING(SS_DOWN(X_LALT)SS_TAP(X_P1)SS_TAP(X_P6)SS_TAP(X_P2)SS_UP(X_LALT));
      } else {
    ...
    case DKA_U:
      if (record->event.pressed) {
        SEND_STRING(SS_DOWN(X_LALT)SS_TAP(X_P1)SS_TAP(X_P6)SS_TAP(X_P3)SS_UP(X_LALT));
      } else {
    ...
    case DKA_MIC:
      if (record->event.pressed) {
        SEND_STRING(SS_DOWN(X_LALT)SS_TAP(X_P2)SS_TAP(X_P3)SS_TAP(X_P0)SS_UP(X_LALT));
      } else {
    ...
    case DKA_LTE:
      if (record->event.pressed) {
        SEND_STRING(SS_DOWN(X_LALT)SS_TAP(X_P2)SS_TAP(X_P4)SS_TAP(X_P3)SS_UP(X_LALT));
      } else {
    ...
    case DKA_GTE:
      if (record->event.pressed) {
        SEND_STRING(SS_DOWN(X_LALT)SS_TAP(X_P2)SS_TAP(X_P4)SS_TAP(X_P2)SS_UP(X_LALT));
      } else {
 ...
 */
[_LOWER] = LAYOUT(
  QK_BOOT, _______, _______, _______, _______, _______,                   KC_PSCR, _______, _______, KC_LBRC, KC_RBRC, KC_DEL,
 ...
 */
  [_ADJUST] = LAYOUT(
  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,                   RGB_MOD, RGB_RMOD, RGB_SAI, RGB_SAD, RGB_VAI, RGB_VAD,
